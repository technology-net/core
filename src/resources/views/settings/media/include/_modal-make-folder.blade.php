    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="create-folder-form" action="{{ route('settings.media.create-folder') }}" method="POST">
                    @csrf
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-success" type="submit">{{ trans('packages/core::common.create') }}</button>
                        </div>
                    </div>
                </form>
            </div>
