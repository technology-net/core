<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="{{ !empty(session('avatar_' . session('user_id'))) ? getPathImage(session('avatar_' . session('user_id'))) : '/core/images/avatar-default.webp' }}" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
